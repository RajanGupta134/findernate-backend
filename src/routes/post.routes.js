...
import { savePost, unsavePost, checkPostSaved, getPrivateSavedPosts, getPublicSavedPosts, toggleSavedPostPrivacy } from "../controllers/savePost.controllers.js";
...
router.route("/saved/toggle/:postId").patch(verifyJWT, toggleSavedPostPrivacy);
